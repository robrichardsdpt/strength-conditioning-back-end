"""
Django settings for strength-conditioning-back-end project.
...
ROOT_URLCONF = 'strength-conditioning-back-end.urls'
...
WSGI_APPLICATION = 'strength-conditioning-back-end.wsgi.application'
