...
This template contains a project, `strength-conditioning-back-end`, and an app, `api`,
...
1. Replace all instances of `strength-conditioning-back-end` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `strength-conditioning-back-end` which should be renamed
...
all instances of `strength-conditioning-back-end` with your app's name.
